...
The main strain of my research so far has been the application of Lie superalgebra cohomology to the study of supersymmetric geometries in supergravity and generalisations thereof, with geometric spin-offs including the study of some [unusual types of Killing spinors which generate Lie (superalgebras)](https://doi.org/10.3842/SIGMA.2025.082) and [generalised spin structures](http://arxiv.org/abs/2511.03627). This was the topic of my PhD, which I obtained at the University of Edinburgh in 2024. [You can read my thesis here](http://dx.doi.org/10.7488/era/4477).
